...
import './MonthlyDialog.css';


const MonthlyDialog = (props) => {
    ...
    <React.Fragment>
      ...
      >
        ...
        >
          ...
          <Tooltip sx={{ ml: 116, mb: 0 }} title="Close">
          ...
          {rows.map((section, idx) => (
            <Accordion key={idx}>
              ...
              <AccordionDetails>
                ...
                <textarea className="score-notes" readOnly value={section.notes}></textarea>
              </AccordionDetails>
            </Accordion>
          ))}
          </div>
        ...
        <DialogActions style={{ justifyContent: "space-between" }}>
          <div>
            <label style={{ fontWeight: 700, marginLeft: "10px" }}>
              ...
              <input className="score-input" value={props.editRow ? props.editRow.score : 'N/A'} readOnly/>
            </label>
          </div>
          <div>
            {/* <Button
